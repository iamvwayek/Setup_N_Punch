    ...
    return (
        <div className="fixed w-full mb-5 bottom-0 z-10">
            <button style={{ display: isActive ? "flex" : "none" }} className="w-full justify-end pr-4">
                <div className="w-12 border-2 border-black flex justify-center items-center bg-black py-2 rounded-full hover:invert transition-all ease-in-out duration-150" onClick={handleTopBtn}>
